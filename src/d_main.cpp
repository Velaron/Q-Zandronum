...
CVAR (Flag, sv_newflyformula,				zadmflags, ZADF_NEW_FLY_FORMULA);
...
CVAR (Flag, compat_allowmoreclientsidefunctions,				zacompatflags, ZACOMPATF_ALLOW_MORE_CLIENTSIDE_FUNCTIONS);
